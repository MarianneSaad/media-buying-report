...
function normalizeName(raw) { let trimmed = raw; for (const code of [8216, 8217]) trimmed = trimmed.split(String.fromCharCode(code)).join("'"); trimmed = trimmed.trim(); const key = trimmed.toLowerCase(); return NAME_ALIASES[key] || trimmed; }
